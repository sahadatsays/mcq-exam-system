...
<body>
    ...
    <div id="page-container"
            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item open">
                            <a class="nav-main-link" href="{{ route('sub-category.index') }}">
                                <i class="nav-main-link-icon si si-globe"></i>
                                <span class="nav-main-link-name">Sub Category</span>
                            </a>
                        </li>
                        {{-- <li class="nav-main-item open">
                            <a class="nav-main-link" href="{{ route('exam.index') }}">
                        <i class="nav-main-link-icon si si-globe"></i>
                        <span class="nav-main-link-name">Examinations</span>
                        </a>
                        </li> --}}

                        <li class="nav-main-item{{ request()->routeIs('question.*') ? ' open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="true" href="#">
                                <i class="nav-main-link-icon si si-bulb"></i>
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->routeIs('question.create') ? ' active' : '' }}"
                                        href="{{ route('question.create') }}">
                                        <span class="nav-main-link-name">Create Questions</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->routeIs('question.index') ? ' active' : '' }}"
                                        href="{{ route('question.index') }}">
                                        <span class="nav-main-link-name">Questions manage</span>
                                    </a>
                                </li>
        ...
        <main id="main-container">
            ...
            <div class="alert alert-{{ session()->get('action')['type'] }}">
                <strong>{{ session()->get('action')['message'] }}</strong>
            </div>
            @endif
            @yield('content')
        </main>
